            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tag Master</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <table id="example" class="table table-striped table-bordered table-hover"
                                ...
                                <tbody>
                                    <?php foreach ($records as $item) {
                                        ...
                                        echo "<td>" . $item->tag . "</td>";
                                        echo "<td>";
                                        if (checkaccess("TAGS", "edit")):
                                            echo '<a href="#" onclick="openmodel(' . $item->id . ')">Edit</a> /';
                                        endif;
                                        if (checkaccess("TAGS", "delete")):
                                            echo '<a href="' . base_url("masters/deletetag/") . $item->id . '" onclick="return confirmdel();">Delete</a>';
                                        endif;
                                        echo "</td>";
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="txttag" placeholder="Enter tag">
                    </div>
                </div>
...
<script>
    ...
    const openmodel = (idn) => {
        ...
        if (row != null && row.length > 0) {
            ...
            jQuery("input[name=txttag]").val(row[0].tag);
            jQuery.noConflict();
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("form").submit(function (e) {
            if (jQuery("input[name=txttag]").val() == "") {
                alert("Enter Tag !!!");
                return false;
            }
        });
